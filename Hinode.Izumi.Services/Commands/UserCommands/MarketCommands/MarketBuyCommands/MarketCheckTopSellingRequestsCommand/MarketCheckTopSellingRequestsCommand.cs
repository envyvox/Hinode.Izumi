...
namespace Hinode.Izumi.Services.Commands.UserCommands.MarketCommands.MarketBuyCommands.
    MarketCheckTopSellingRequestsCommand
{
    ...
    public class MarketCheckTopSellingRequestsCommand : IMarketCheckTopSellingRequestsCommand
    {
        ...
        public MarketCheckTopSellingRequestsCommand(IDiscordEmbedService discordEmbedService,
        ...
        public async Task Execute(SocketCommandContext context, MarketCategory category, string pattern = null)
        {
            ...
            var requests = await _marketService.GetMarketRequest(category, true, pattern);
