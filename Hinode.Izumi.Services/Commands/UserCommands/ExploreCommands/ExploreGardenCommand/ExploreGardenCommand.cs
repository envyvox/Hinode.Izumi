...
namespace Hinode.Izumi.Services.Commands.UserCommands.ExploreCommands.ExploreGardenCommand
{
    ...
    public class ExploreGardenCommand : IExploreGardenCommand
    {
        ...
        public ExploreGardenCommand(IDiscordEmbedService discordEmbedService, IEmoteService emoteService,
        ...
        public async Task Execute(SocketCommandContext context)
        {
            ...
            await _locationService.UpdateUserLocation((long) context.User.Id, Location.ExploreGarden);
