...
namespace Hinode.Izumi.Services.GameServices.LocalizationService
{
    public interface ILocalizationService
    {
        ...
        Task<LocalizationRecord> GetLocalizationByLocalizedWord(LocalizationCategory category, string localizedWord);
        ...
        /// <returns>Локализация.</returns>
        /// <exception cref="IzumiNullableMessage"></exception>
        Task<LocalizationRecord> GetLocalizationByLocalizedWord(InventoryCategory category, string localizedWord);
        ...
        /// <returns>Локализация.</returns>
        /// <exception cref="IzumiNullableMessage"></exception>
        Task<LocalizationRecord> GetLocalizationByLocalizedWord(MarketCategory category, string localizedWord);
