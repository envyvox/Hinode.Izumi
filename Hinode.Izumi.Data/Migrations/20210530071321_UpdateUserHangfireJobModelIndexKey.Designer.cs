...
namespace Hinode.Izumi.Data.Migrations
{
    ...
    [Migration("20210530071321_UpdateUserHangfireJobModelIndexKey")]
    partial class UpdateUserHangfireJobModelIndexKey
    {
            ...
            modelBuilder.Entity("Hinode.Izumi.Data.Models.UserModels.UserHangfireJob", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_user_hangfire_jobs_user_id");
