    ...
    public static class TrainingStepHelper
    {
        ...
        public static string Description(this TrainingStep step) => step switch
        {
            ...
            TrainingStep.CookFriedEgg =>
                ...
                "На этот раз я подарю тебе <:Recipe:813150911530401844> рецепт и <:Egg:813145655316971581> необходимые ингредиенты, однако в будущем тебе придется покупать <:Recipe:813150911530401844> рецепты и добывать все ингредиенты самостоятельно.\n\n" +
                "А теперь напиши `!приготовить 4`.",
